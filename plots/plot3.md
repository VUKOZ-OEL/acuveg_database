---
layout: single
title: "Hospodaření v buku - středněvěký porost"
sidebar:
  nav: "main"
...
{% assign data_off = site.data.noise.plot3_off %}
...
{% assign data_lidar = site.data.lidar.plot3 %}
...
## Meteorologická data
{% assign data = site.data.meteodata.plot3 %}
...
{% for file in site.data.images.plots %}
  <div>
    <a href="{{ '/assets/images/plot3/on/' | append: file | relative_url }}" target="_blank">
      <img 
        src="{{ '/assets/images/plot3/on/' | append: file | relative_url }}" 
        style="height:100px;">
    </a>
  </div>
{% endfor %}
...
{% for file in site.data.images.plots %}
  <div>
    <a href="{{ '/assets/images/plot3/off/' | append: file | relative_url }}" target="_blank">
      <img 
        src="{{ '/assets/images/plot3/off/' | append: file | relative_url }}" 
        style="height:100px;">
    </a>
  </div>
{% endfor %}
