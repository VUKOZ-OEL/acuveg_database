---
layout: single
title: "Les trvale tvořivý - mladý porost"
sidebar:
  nav: "main"
...
{% assign data_off = site.data.noise.plot5_off %}
...
{% assign data_lidar = site.data.lidar.plot5 %}
...
## Meteorologická data
{% assign data = site.data.meteodata.plot5 %}
...
{% for file in site.data.images.plots %}
  <div>
    <a href="{{ '/assets/images/plot5/on/' | append: file | relative_url }}" target="_blank">
      <img 
        src="{{ '/assets/images/plot5/on/' | append: file | relative_url }}" 
        style="height:100px;">
    </a>
  </div>
{% endfor %}
...
{% for file in site.data.images.plots %}
  <div>
    <a href="{{ '/assets/images/plot5/off/' | append: file | relative_url }}" target="_blank">
      <img 
        src="{{ '/assets/images/plot5/off/' | append: file | relative_url }}" 
        style="height:100px;">
    </a>
  </div>
{% endfor %}
