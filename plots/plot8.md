...
{% for file in site.data.images.plots %}
  <div>
    <a href="{{ '/assets/images/plot8/on/' | append: file | relative_url }}" target="_blank">
      <img 
        src="{{ '/assets/images/plot8/on/' | append: file | relative_url }}" 
        style="height:100px;">
    </a>
  </div>
{% endfor %}
...
{% for file in site.data.images.plots %}
  <div>
    <a href="{{ '/assets/images/plot8/off/' | append: file | relative_url }}" target="_blank">
      <img 
        src="{{ '/assets/images/plot8/off/' | append: file | relative_url }}" 
        style="height:100px;">
    </a>
  </div>
{% endfor %}
