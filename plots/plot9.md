    ...
    <tr class="section">
      <td colspan="7">
        {% if sekce == "vege" %}
          Vegetační sezóna
        {% elsif sekce == "mimo" %}
          Mimo vegetační sezónu - bez sněhu
        {% elsif sekce == "snih" %}
...
{% for file in site.data.images.plot9 %}
  <div>
    <a href="{{ '/assets/images/plot9/on/' | append: file | relative_url }}" target="_blank">
      <img 
        src="{{ '/assets/images/plot9/on/' | append: file | relative_url }}" 
        style="height:100px;">
    </a>
  </div>
{% endfor %}
...
{% for file in site.data.images.plot9 %}
  <div>
    <a href="{{ '/assets/images/plot9/off/' | append: file | relative_url }}" target="_blank">
      <img 
        src="{{ '/assets/images/plot9/off/' | append: file | relative_url }}" 
        style="height:100px;">
    </a>
  </div>
{% endfor %}
...
{% for file in site.data.images.plot9 %}
  <div>
    <a href="{{ '/assets/images/plot9/snow/' | append: file | relative_url }}" target="_blank">
      <img 
        src="{{ '/assets/images/plot9/snow/' | append: file | relative_url }}" 
        style="height:100px;">
    </a>
  </div>
{% endfor %}
